...
public class Main {
    ...
    Reference ref = new Reference(ratings);
       //System.out.println(ref.similarityCalc(mikke, pekka));
       //System.out.println(ref.similarityCalc(mikke, matti));
       //System.out.println(ref.similarityCalc(matti, pekka));
       //System.out.println(ref.similarityCalc(matti, thomas));
       
      // for (Person p : ratings.reviewers()) {
      //     System.out.println(p +" similar to "+ ref.similarTo(p));
      // }
